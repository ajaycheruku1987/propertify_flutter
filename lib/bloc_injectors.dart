...
import 'package:propertify/features/create_post/repo/create_post_repository.dart';
import 'package:propertify/features/home/repo/home_repo.dart';
...
import 'package:propertify/features/services/repo/services_repo.dart';
import 'package:propertify/features/services/repo/price_repo.dart';
import 'package:propertify/features/sales/repo/sales_repo.dart';
import 'package:propertify/features/requests/bloc/requests_bloc.dart';
import 'package:propertify/features/requests/repo/requests_repo.dart';
...
final List<BlocProvider> blocInjectors = [
  ...
  BlocProvider<ServicesBloc>(
    create:
        (context) => ServicesBloc(
          serviceLocator<ServicesRepo>(),
          serviceLocator<PriceRepo>(),
        ),
  ),
