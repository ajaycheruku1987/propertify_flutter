...
extension StringCapitalization on String {
  ...
  /// Supports comma-separated strings by translating each part individually
  String translate(BuildContext context) {
    if (contains(',')) {
      return split(',')
          .map((part) => part.trim()._translateSingle(context))
          .join(', ');
    }
    return _translateSingle(context);
  }

  String _translateSingle(BuildContext context) {
    final l10n = AppLocalizations.of(context);
    if (l10n == null) return this;

    final key = toLowerCase().trim().replaceAll(RegExp(r'\s+'), '');

    // Manual mapping for common dynamic strings
    switch (key) {
      case 'independenthouse':
        return l10n.independentHouse;
      case 'villa':
        return l10n.villa;
      case 'villas':
        return l10n.villas;
      ...
      case 'flats':
        return l10n.flats;
      case 'apartmentflat':
        return l10n.apartmentFlat;
      case 'openplot':
        return l10n.openPlot;
      case 'openplots':
        return l10n.openPlots;
      case 'agricultureland':
        return l10n.agricultureLand;
      case 'commercial':
      ...
      case 'cement':
        return l10n.cement;
      case 'buildingmaterialsupply':
        return l10n.buildingMaterialSupply;
      case 'legal':
        return l10n.legal;
      case 'documentverification':
        return l10n.documentVerification;
      case 'advocate':
        return l10n.advocate;
      case 'constructioncontractor':
        return l10n.constructionContractor;
      case 'propertyvaluation':
        return l10n.propertyValuation;
      case 'leasing':
        return l10n.leasing;
      case 'house':
        return l10n.house;
      ...
      case 'units':
        return l10n.noOfUnits;
      case 'totalprojectarea':
        return l10n.totalProjectArea;
      case 'totalbuiltuparea':
        return l10n.totalBuiltUpArea;
      default:
        return this;
    }
  }
