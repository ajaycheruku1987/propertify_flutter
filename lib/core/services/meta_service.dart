...
class MetaService {
  ...
  static const String _accessToken =
      'EAASzcoBEi8ABSJwRF3ZAx0bFD3CrGfY6BT83XcSupahOA7Liz8zSq8tkA1QVilQiwcZC0fW3AAc0ZCJqcauGeP0YkZB99gMEUDnqmmU4RrJoOlolLmKZAEgdZAg6qjZAXrc914jbotwNopLFSJfL1mMo6SBujMh8ZBbv4eo5Urkwo9PBB0p0CeSEwh6UZBOYZCQQ40yaU9gxvU';
  ...
  static const String _accessTokenInsta =
      'EAASzcoBEi8ABSExc9jFq9IKsvms65NfEXN01uvirEA18jolzdz2Wn55jQVbmmB5XZAr10SbuTRq2IZBca9U0Gu05VOmfuXclU1N1xTXr9IQeTtZCxneZBMEYUtxUv63ul8pDfhU9xs66UwFP8ue5x2CTZBta5gWlkPjbbiYm6YZA8d5qFSJuj1dcRS7xux';
  ...
  Future<void> autoPostToSocials({
    ...
    // NOTE: Social auto-posting (Facebook/Instagram) has been moved to the
    // backend. The client-side posting below is disabled to avoid duplicate
    // posts. Keeping the code commented out for reference.
  ...
  Future<void> postToInstagram({
    ...
    try {
      ...
      Map<String, dynamic> data = (responseData is String)
      ...
      if (creationId != null) {
        debugPrint(
          "Instagram Container Created: $creationId. Waiting for processing...",
        );
        ...
        final publishResponse = await _dio.post(
          ...
          data: {'creation_id': creationId, 'access_token': _accessTokenInsta},
        );
