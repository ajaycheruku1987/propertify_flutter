...
abstract class _AdminState implements AdminState {
  const factory _AdminState(
      ...
      final List<AdminCompanyModel>? gstVerifiedCompanies,
      final int currentGstVerifiedPage,
      final bool hasMoreGstVerified}) = _$AdminStateImpl;
