...
_$CallbackRequestModelImpl _$$CallbackRequestModelImplFromJson(
        Map<String, dynamic> json) =>
    _$CallbackRequestModelImpl(
...
Map<String, dynamic> _$$CallbackRequestModelImplToJson(
        _$CallbackRequestModelImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
