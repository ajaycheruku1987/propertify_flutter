...
_$MyCompanyResponseModelImpl _$$MyCompanyResponseModelImplFromJson(
...
Map<String, dynamic> _$$MyCompanyResponseModelImplToJson(
        _$MyCompanyResponseModelImpl instance) =>
    <String, dynamic>{
      'id': instance.id,
