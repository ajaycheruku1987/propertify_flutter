  ...
  Widget build(BuildContext context) {
    return BlocBuilder<CompanyBloc, CompanyState>(
      builder: (context, state) {
        final companyId = state.createCompanyResponse?.id;
        return Scaffold(
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border:
                          Border.all(color: const Color(0xFFF0E6FF), width: 8),
                      color: Colors.white,
                    ),
                    child: Center(
                      child: RichText(
                  ...
                  SizedBox(
                    ...
                    child: CommonCustomButton(
                      onTap: () {
                        ...
                        // Pass the company ID so the payment is linked correctly
                        context.push(
                          '/verification-payment?type=gst&entityId=$companyId&showSkip=true',
                        );
                      },
